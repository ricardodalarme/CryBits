...
internal sealed class PlayerSender(PackageSender packageSender)
{
    ...
    {
        _packageSender.ToPlayer(player, new JoinPacket { Name = player.Name });
    }

    public void JoinGame(Player player)
    {
        _packageSender.ToPlayer(player, new JoinGamePacket());
    }

    public void JoinMap(Player player)
    {
        _packageSender.ToPlayer(player, new JoinMapPacket());
    }

    public void PlayerLeaveMap(Player player, MapInstance mapInstance)
    {
        _packageSender.ToMapBut(mapInstance, player, new PlayerLeavePacket { Name = player.Name });
    }

    public void PlayerPosition(Player player)
    {
        _packageSender.ToMap(player.MapInstance,
    ...
    public void PlayerVitals(Player player)
    {
        ...
        _packageSender.ToMap(player.MapInstance, packet);
    }

    public void PlayerLeave(Player player)
    {
        _packageSender.ToAllBut(player, new PlayerLeavePacket { Name = player.Name });
    }
    ...
    public void PlayerMove(Player player, byte movement)
    {
        ...
        _packageSender.ToMapBut(player.MapInstance, player,
    ...
    {
        _packageSender.ToPlayer(player,

...
partial class Graphics
{
    ...
    public static void Game_Menu_Character()
    {
        ...
        // Atributos
        DrawText("Strength: " + Player.Me.Attribute[(byte)Game.Atributos.Strength], Panel_Position.X + 32, Panel_Position.Y + 146, SFML.Graphics.Color.White);
        DrawText("Resistance: " + Player.Me.Attribute[(byte)Game.Atributos.Resistance], Panel_Position.X + 32, Panel_Position.Y + 162, SFML.Graphics.Color.White);
        DrawText("Intelligence: " + Player.Me.Attribute[(byte)Game.Atributos.Intelligence], Panel_Position.X + 32, Panel_Position.Y + 178, SFML.Graphics.Color.White);
        DrawText("Agility: " + +Player.Me.Attribute[(byte)Game.Atributos.Agility], Panel_Position.X + 32, Panel_Position.Y + 194, SFML.Graphics.Color.White);
        DrawText("Vitality: " + +Player.Me.Attribute[(byte)Game.Atributos.Vitality], Panel_Position.X + 32, Panel_Position.Y + 210, SFML.Graphics.Color.White);
    ...
    public static void Painel_Informations(short Item_Num, int X, int Y)
    {
        ...
        {
            for (byte n = 0; n <= (byte)Game.Atributos.Amount - 1; n++) DrawText(((Game.Atributos)n).ToString() + ": " + Lists.Item[Item_Num].Equip_Attribute[n], Position.X + 100, Position.Y + 18 + 12 * n, SFML.Graphics.Color.White);

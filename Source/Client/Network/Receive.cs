...
partial class Receive
{
    ...
    public static void Items(NetIncomingMessage Data)
    {
        ...
        for (byte i = 1; i <= Lists.Item.GetUpperBound(0); i++)
        {
            ...
            Lists.Item[i].Equip_Attribute = new short[(byte)Game.Atributos.Amount];
            ...
            for (byte n = 0; n <= (byte)Game.Atributos.Amount - 1; n++) Lists.Item[i].Equip_Attribute[n] = Data.ReadInt16();

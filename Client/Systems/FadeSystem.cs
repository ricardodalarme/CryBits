...
/// Decrements <see cref="SpriteComponent.Opacity"/> by <see cref="FadeComponent.AmountPerTick"/> every <see cref="FadeComponent.IntervalSeconds"/> seconds.
/// </summary>
internal sealed class FadeSystem(World world) : BaseSystem<World, float>(world)
{
    ...
    public override void Update(in float deltaTime)
    {
        ...
        World.Query(in _query, (Entity entity, ref FadeComponent fade, ref SpriteComponent sprite) =>
        {
            ...
            sprite.Opacity = (byte)Math.Max(0, sprite.Opacity - fade.AmountPerTick);

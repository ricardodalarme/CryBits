...
internal class ToolsRepository
{
    ...
    public void Read()
    {
        ...
        foreach (var screenDto in root.Screens)
        {
            ...
            var node = _interfaceData.Tree.Nodes.Add("[Window] " + screen.Name);
            node.Tag = screen;
    ...
    public void Write()
    {
        ...
        foreach (var screenNode in _interfaceData.Tree.Nodes)
        {

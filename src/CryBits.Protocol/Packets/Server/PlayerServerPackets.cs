...
{
    public long NetworkId; public string Name = string.Empty; public short TextureNum, Level; public Guid MapId; public byte X, Y, Direction;
...
[MemoryPackable] public partial class PlayerHotbarPacket : IServerPacket { public byte[] Types = [], Slots = []; }

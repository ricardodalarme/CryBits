...
internal sealed class TradeInvitationView
{
    private static TradeInvitationView? _instance;
    ...
    public TradeInvitationView(UISystem ui)
    {
        _instance = this;
        _ui = ui;
    ...
    public void Build(Panel root)
    {
        ...
        {
            TextureId = "Textures/Panels/18.png",
    ...
    {
        _tradeSender.TradeAccept();
        _panel!.Visible = false;
    }

    private void OnDeclinePressed()
    {
        _tradeSender.TradeDecline();
        _panel!.Visible = false;
    }
    ...
    public static void Show(string inviterName)
    {
        ...
        _instance._inviterNameLabel!.Text = $"{inviterName} has invited you to a trade. Would you like to join?";

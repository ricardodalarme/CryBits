...
internal sealed class DropItemView
{
    private static DropItemView? _instance;
    private readonly PlayerSender _playerSender;
    ...
    public DropItemView(UISystem ui)
    {
        _instance = this;
        _ui = ui;
        _playerSender = PlayerSender.Instance;
    }
    ...
    public void Build(Panel root)
    {
        ...
        {
            TextureId = "Textures/Panels/16.png",
        ...
        {
            TextureId = "Textures/Buttons/23.png",
        ...
        _cancelButton.Offset.SetPixels(80, 40);
    ...
    private void OnConfirmPressed()
    {
        ...
        _playerSender.DropItem(InventorySlot, amount);
        _panel!.Visible = false;
    }
